...
namespace PacketPeepScript
{
    ...
    public class CharacterCombatViewUpdate : BaseScript
    {
        ...
        enum ShadowFieldIndex : byte
        {
            ...
            Unk_0x54_MovementPermissions = 0x54, // Just a guess. This field appears to match 0x5e in CombatController.
        }
        ...
        public byte[] Unk_0x54_MovementPermissions;
        public uint? Unk_0x54_MovementPermissions_Time;
        ...
        public override void Read(Bitter.BinaryStream Stream)
        {
            ...
            do
            {
                ...
                switch (sfidx)
                {
                    ...
                    case ShadowFieldIndex.Unk_0x54_MovementPermissions:
                        Unk_0x54_MovementPermissions = Stream.Read.ByteArray(4);
                        Unk_0x54_MovementPermissions_Time = Stream.Read.UInt();
                        break;
