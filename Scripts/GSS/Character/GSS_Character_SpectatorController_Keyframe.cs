...
{
    [Script(MessageType.GSS, 7, 4, true)]
    public class CharacterSpectatorControllerKeyframe : BaseScript
    {
        ...
        public override void Read(Bitter.BinaryStream Stream)
        {
            ...
            if (true)
            {
                ...
                Bitfield = Stream.Read.BitArray(8);

                PingTime = Stream.Read.UInt();
                SpectatorMode = Stream.Read.Byte();

                if (Bitfield[(int)BitfieldIndex.CinematicCamera] == 0)
                {
                    PeepWarning += "CinematicCamera";
                }
            }
