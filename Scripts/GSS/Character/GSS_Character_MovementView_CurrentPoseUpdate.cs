[Aero(AeroType.Msg, AeroMsgType.GSS, AeroSrc.Server, 12, 110, Ver: 1962)]
public partial class CharacterMovementViewCurrentPoseUpdate : AeroBase
{
    public byte Flags;
...
[Aero(AeroType.Block)]
public partial class FullDataVersion : AeroBase
{
    public byte Unk1;
