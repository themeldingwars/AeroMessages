...
namespace PacketPeepScript
{
    ...
    public class CharacterCombatViewUpdate : BaseScript
    {
        enum ShadowFieldIndex : byte
        {
            ...
            Reset_AppendageHealthPools_0 = 0xd5,
            Reset_AppendageHealthPools_1 = 0xd6,
            Reset_AppendageHealthPools_2 = 0xd7,
            Reset_AppendageHealthPools_3 = 0xd8,
            Reset_AppendageHealthPools_4 = 0xd9,
            Reset_AppendageHealthPools_5 = 0xda,
            Reset_AppendageHealthPools_6 = 0xdb,
            Reset_AppendageHealthPools_7 = 0xdc,
            Reset_AppendageHealthPools_8 = 0xdd,
            Reset_AppendageHealthPools_9 = 0xde,

            Reset_NPCTargetObjId = 0xe9,
            Reset_BattleChatterTag = 0xea,
        }
